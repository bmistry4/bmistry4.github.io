...
- **Why?** (_Motivation/Background story_.) A few months ago, someone close to me had gone on a holiday to Wales, 
...
Here's it is (<span style="color: red;">I've added markings on the QR code to stop the scan from working since it's for private use only)</span>: 

TODO - ADD IMAGE
<!-- ![canvas print damaged.jpg](images%2Fcanvas%20print%20damaged.jpg) -->
